import { createElement, type ElementType, type ReactNode, useCallback, useEffect, useMemo, useRef, useState } from 'react';
...
export default function TextType({
  ...
  return (
    <span ref={containerRef} className="text-type-observer">
      {createElement(
        Component,
        {
